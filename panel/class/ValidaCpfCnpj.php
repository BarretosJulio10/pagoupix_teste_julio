...
class ValidaCpfCnpj
{
	...
	protected function valida_cpf() {
		...
		if ($this->cpf_invalidos($this->valor)) {
	...
	protected function valida_cnpj () {
		...
		if ($this->cnpj_invalidos($this->valor)) {
			// O valor original
	...
	public function cpf_invalidos($num){
		$return 			= TRUE;
		$num 				= $this->limpa_numero($num);
		$arr_num_invalidos 	= array('11111111111','22222222222','33333333333','44444444444','55555555555','66666666666','77777777777','88888888888','99999999999','00000000000');
		if (in_array($num, $arr_num_invalidos)) {
			$return = FALSE;
		}
		return $return;
	}

	public function cnpj_invalidos($num){
		$return 			= TRUE;
		$num 				= $this->limpa_numero($num);
		$arr_num_invalidos 	= array('11111111111111','22222222222222','33333333333333','44444444444444','55555555555555','66666666666666','77777777777777','88888888888888','99999999999999','00000000000000');
		if (in_array($num, $arr_num_invalidos)) {
			$return = FALSE;
		}
		return $return;
    ...
    public function limpa_numero($str) {
